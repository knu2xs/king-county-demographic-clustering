...
SETLOCAL
SET PROJECT_DIR=%cd%
SET PROJECT_NAME=king-county-demographic-clustering
SET SUPPORT_LIBRARY = demograpic_clustering
SET ENV_NAME=demographic-clustering
...
:build_upload
    ENDLOCAL & (
        ...
        :: Build conda package
        CALL conda build ./conda-recipe --output-folder ./conda-recipe/conda-build
        CALL anaconda upload ./conda-recipe/conda-build/win-64/king-county-demographic-clustering*.tar.bz2
